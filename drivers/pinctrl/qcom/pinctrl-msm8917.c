...
{
	unsigned int i;
	const msm_pin_function *func;

	if (pin >= N_GPIO)
		return -EINVAL;

	func = msm8917_pin_functions + pin;
...
static const struct msm_pinctrl_data msm8917_data = {
	...
	.functions_count = ARRAY_SIZE(msm8917_pinctrl_functions),
